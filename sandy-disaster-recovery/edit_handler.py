...
class EditHandler(base.AuthenticatedHandler):
  def AuthenticatedGet(self, org, event):
	...
	elif k in ["appliance_removal",  "appliances_inspected",  "appliances_permits_acquired",  "appliances_waiver_signed",  "appliances_waste_removal_required",  "carpet_removal",  "claim_for_org",  "doors_inspected",  "doors_permits_acquired",  "doors_waiver_signed",  "doors_waste_removal_required",  "drywall_removal",  "dump_trailer_needed",  "electrical_inspected",  "electrical_lines",  "electrical_permits_acquired",  "electrical_waiver_signed",  "electrical_waste_removal_required",  "electricity",  "first_responder",  "floors_carpet",  "floors_hardwood_floor",  "floors_inspected",  "floors_permits_acquired",  "floors_subfloor",  "floors_waiver_signed",  "floors_waste_removal_required",  "gutting_done",  "habitable",  "hardwood_floor_removal",  "heavy_item_removal",  "help_install_tarp",  "hoarder",  "house_roof_damage",  "hvac_inspected",  "hvac_permits_acquired",  "hvac_waiver_signed",  "hvac_waste_removal_required",  "insured",  "kitchen_bath_inspected",  "kitchen_bath_permits_acquired",  "kitchen_bath_waiver_signed",  "kitchen_bath_waste_removal_required",  "maintenance_caulking",  "maintenance_doors",  "maintenance_electrical",  "maintenance_hvac",  "maintenance_plumbing",  "maintenance_roof",  "maintenance_septic",  "maintenance_siding",  "maintenance_windows",  "member_of_assessing_organization",  "mold_drying",  "mold_hvac",  "mold_remediation",  "mold_replace_studs",  "mold_scraping",  "mold_spraying",  "mold_supression_done",  "needs_visual",  "nonvegitative_debris_removal",  "older_than_60",  "outbuilding_roof_damage",  "plumbing_inspected",  "plumbing_permits_acquired",  "plumbing_septic",  "plumbing_waiver_signed",  "plumbing_waste_removal_required",  "pump_needed",  "release_form",  "roof_gutters_inspected",  "roof_gutters_permits_acquired",  "roof_gutters_shingles",  "roof_gutters_tarping",  "roof_gutters_waiver_signed",  "roof_gutters_waste_removal_required",  "siding_inspected",  "siding_permits_acquired",  "siding_waiver_signed",  "siding_waste_removal_required",  "standing_water",  "unsafe_roof",  "vegitative_debris_removal",  "walls_drywall",  "walls_framing",  "walls_gutting",  "walls_inspected",  "walls_insulation",  "walls_mold_remediation",  "walls_permits_acquired",  "walls_waiver_signed",  "walls_waste_removal_required",  "windows_inspected",  "windows_permits_acquired",  "windows_waiver_signed",  "windows_waste_removal_required",  "work_without_resident"]:
	  try:
	    if v == "y":
	      id_index = new_inc_form.index('id="' + k)
	      value_index = new_inc_form[id_index:].index(">")
