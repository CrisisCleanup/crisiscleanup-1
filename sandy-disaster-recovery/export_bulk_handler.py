...
SC_FAST_TRACK_FIELDS_LIST = ['case_number', 'request_date', 'Days Waiting From %(today)s', 'reported_by', 'walls_claimed_by', 'walls_status', 'electrical_claimed_by', 'electrical_status', 'floors_claimed_by', 'floors_status', 'plumbing_claimed_by', 'plumbing_status', 'kitchen_bath_claimed_by', 'kitchen_bath_status', 'hvac_claimed_by', 'hvac_status', 'appliances_claimed_by', 'appliances_status', 'doors_claimed_by', 'doors_status', 'windows_claimed_by', 'windows_status', 'siding_claimed_by', 'siding_status', 'roof_gutters_claimed_by', 'roof_gutters_status', 'name', 'address', 'city', 'county', 'state', 'zip_code', 'latitude', 'longitude', 'cross_street', 'phone1', 'phone2', 'email', 'secondary_contact_name', 'secondary_contact_phone', 'time_to_call', 'do_not_work_before', 'work_requested', 'work_type', 'dwelling_type', 'rent_or_own', 'fema_housing_award', 'work_without_resident', 'older_than_60', 'special_needs', 'gutting_done', 'mold_supression_done', 'walls_flood_height', 'walls_gutting', 'walls_mold_remediation', 'walls_framing', 'walls_drywall', 'walls_insulation', 'walls_damage_description', 'walls_floor_affected', 'walls_inspected', 'walls_waste_removal_required', 'walls_waiver_signed', 'walls_permits_acquired', 'walls_notes', 'electrical_damage_description', 'electrical_floor_affected', 'electrical_inspected', 'electrical_waste_removal_required', 'electrical_waiver_signed', 'electrical_permits_acquired', 'electrical_notes', 'floors_inspected', 'floors_carpet', 'floors_hardwood_floor', 'floors_subfloor', 'floors_damage_description', 'floors_floor_affected', 'floors_waste_removal_required', 'floors_waiver_signed', 'floors_permits_acquired', 'floors_notes', 'plumbing_septic', 'plumbing_damage_description', 'plumbing_floor_affected', 'plumbing_inspected', 'plumbing_waste_removal_required', 'plumbing_waiver_signed', 'plumbing_permits_acquired', 'plumbing_notes', 'kitchen_bath_damage_description', 'kitchen_bath_floor_affected', 'kitchen_bath_inspected', 'kitchen_bath_waste_removal_required', 'kitchen_bath_waiver_signed', 'kitchen_bath_permits_acquired', 'kitchen_bath_notes', 'hvac_damage_description', 'hvac_floor_affected', 'hvac_inspected', 'hvac_waste_removal_required', 'hvac_waiver_signed', 'hvac_permits_acquired', 'hvac_notes', 'appliances_damage_description', 'appliances_floor_affected', 'appliances_inspected', 'appliances_waste_removal_required', 'appliances_waiver_signed', 'appliances_permits_acquired', 'appliances_notes', 'doors_damage_description', 'doors_floor_affected', 'doors_inspected', 'doors_waste_removal_required', 'doors_waiver_signed', 'doors_permits_acquired', 'doors_notes', 'windows_damage_description', 'windows_floor_affected', 'windows_inspected', 'windows_waste_removal_required', 'windows_waiver_signed', 'windows_permits_acquired', 'windows_notes', 'siding_damage_description', 'siding_floor_affected', 'siding_inspected', 'siding_waste_removal_required', 'siding_waiver_signed', 'siding_permits_acquired', 'siding_notes', 'roof_gutters_shingles', 'roof_gutters_tarping', 'roof_gutters_damage_description', 'roof_gutters_floor_affected', 'roof_gutters_inspected', 'roof_gutters_waste_removal_required', 'roof_gutters_waiver_signed', 'roof_gutters_permits_acquired', 'roof_gutters_notes', 'habitable', 'electricity', 'electrical_lines', 'unsafe_roof', 'other_hazards', 'claim_for_org', 'status', 'assigned_to', 'total_volunteers', 'hours_worked_per_volunteer', 'initials_of_resident_present', 'status_notes', 'prepared_by']
