...
MIDWEST_WINTER_FLOOD_FIELDS_LIST = ['claimed_by', 'reported_by', 'modified_by', 'case_number', 'Days Waiting From %(today)s', 'request_date', 'name', 'work_type', 'address', 'city', 'county', 'state', 'zip_code', 'latitude', 'longitude', 'cross_street', 'phone1', 'phone2', 'email', 'time_to_call', 'do_not_work_before', 'work_waiver_signed', 'work_requested', 'house_affected', 'outbuilding_affected', 'exterior_property_affected', 'destruction_level', 'rent_or_own', 'member_of_assessing_organization', 'work_without_resident', 'older_than_60', 'special_needs', 'priority', 'flood_height', 'floors_affected', 'carpet_removal', 'hardwood_floor_removal', 'drywall_removal', 'appliance_removal', 'heavy_item_removal', 'standing_water', 'mold_remediation', 'pump_needed', 'notes', 'nonvegitative_debris_removal', 'vegitative_debris_removal', 'debris_blocking', 'house_roof_damage', 'outbuilding_roof_damage', 'tarps_needed', 'help_install_tarp', 'num_trees_down', 'num_wide_trees', 'trees_blocking', 'uninhabitable', 'electricity', 'heat', 'electrical_lines', 'unsafe_roof', 'other_hazards', 'claim_for_org', 'status', 'assigned_to', 'muck_gut_complete', 'mold_sanitation_complete', 'debris_pick_up', 'total_volunteers', 'hours_worked_per_volunteer', 'initials_of_resident_present', 'status_notes', 'prepared_by']
...
def get_csv_fields_list(event_short_name):
    ...
    elif event_short_name == "ms_floods":
