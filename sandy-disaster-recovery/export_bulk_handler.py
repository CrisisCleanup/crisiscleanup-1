...
PH_CSV_FIELD_LIST = ["claimed_by", "reported_by", "modified_by", "case_number", "Days Waiting From %(today)s", "name", "request_date", "address", "city", "county", "state", "zip_code", "latitude", "longitude", "blurred_latitude", "blurred_longitude", "cross_street", "phone1", "phone2", "time_to_call", "gender", "age", "work_type", "report_incident", "priority", "claim_for_org", "status", "assigned_to",   "prepared_by",  "type_of_communication", "correct", "message", "response_to_communications_compaign", "message_type"]
